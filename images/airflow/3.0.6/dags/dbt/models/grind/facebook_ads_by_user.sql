...
WITH fbads_by_user AS {{ facebook_ads_name_json_cte('supermetrics', 'fbads_facebook_ads_by_user')}}
SELECT 
  {{ hash_natural_key('TRY_TO_NUMERIC(ad_id)::INT', 'TRY_TO_NUMERIC(campaign_id)::INT', 'date', 'age','gender') }} AS id
