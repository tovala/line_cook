{% macro summarize_negative_menu_feedback(text_to_summarize) %}
    [
        {
            'role': 'system',
            'content': CONCAT(
                ...
                , 'A concise bullet-point summary of the primary NEGATIVE themes related to the menu.\n'
                , 'Quantification of each negative theme, including both the count and approximate percentage of total comments analyzed.\n'
